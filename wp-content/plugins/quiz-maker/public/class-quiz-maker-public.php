...
class Quiz_Maker_Public
{
    ...
    /*******************************************************************************************************/
        ...
        if($options['form_name'] == "on"){
            $show_form = "show";
            $form_inputs .= "<input type='text' name='ays_user_name' placeholder='". $this->fields_placeholders['namePlaceholder'] ."' class='ays_quiz_form_input ays_animated_x5ms' " . $name_required . ">";
        }else{
        ...
        if($options['form_email'] == "on"){
            $show_form = "show";
            $form_inputs .= "<input type='text' name='ays_user_email' placeholder='". $this->fields_placeholders['emailPlaceholder'] ."' class='ays_quiz_form_input ays_animated_x5ms' " . $email_required . ">";
        }else{
        ...
        if($options['form_phone'] == "on"){
            $show_form = "show";
            $form_inputs .= "<input type='text' name='ays_user_phone' placeholder='". $this->fields_placeholders['phonePlaceholder'] ."' class='ays_quiz_form_input ays_animated_x5ms' " . $phone_required . ">";
        }else{
            ...
            if (!empty($question)) {
                ...
                $container_first_part = "<div class='step ".$not_influence_to_score_class."' data-question-id='" . $question["id"] . "'>
                    ...
                    <div class='ays-abs-fs'>
                        {$question_category}
                        {$question_html}
                        <div class='ays-quiz-answers $answer_view_class $max_selection_number_class'>";
