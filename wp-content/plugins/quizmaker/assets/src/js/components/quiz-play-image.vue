<template>
	<div :class="{quiz_play_finish: is_finish_data}" class="quiz-play-item quiz-play-image">
		<v-container fluid grid-list-lg>
			...
			<v-layout row wrap class="play-answers ans-text">
				<v-flex xs12 md4 v-for="(q, index) in content.options" :key="index">
						
						<div class="answer" @click="answer(q.id)">
							<img :src="q.content[0]" width="100%" height="auto" />
						</div>
