<template>
  <div class="quiz-composer quiz-groupmatch-question">
          ...
          <div v-for="(q, index) in questions" :key="index" class="item mb-2">
                ...
                <div class="white pl-3 pr-3">
                  ...
                  <div>
                    ...
                    <v-text-field v-model="q.group" label="Hint Text" single-line></v-text-field>

                    <v-text-field v-model="q.item" label="Hint Text" single-line></v-text-field>
  ...
  data: function(){
    ...
    if( typeof this.question.options == 'undefined' ) {
      ...
      this.question.options = [
            { id: 1, group: 'Group 1', item: 'Text 1' },
            { id: 2, group: 'Group 2', item: 'Text 2' },
            { id: 3, group: 'Group 1', item: 'Text 3' }
          ];
    }
