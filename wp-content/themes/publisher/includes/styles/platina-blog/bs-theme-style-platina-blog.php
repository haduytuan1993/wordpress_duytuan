...
/**
 * Publisher -> Platina Blog
 */
class Publisher_Theme_Style_Platina_Blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/platina-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/platina-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-platina-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'platina-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'platina-blog/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-platina-blog' );
	}
...
} // Publisher_Theme_Style_Platina_Blog
