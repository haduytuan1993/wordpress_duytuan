...
$theme_color['border_color']['selector'][] = 'a.read-more';
...
$theme_color['bg_color']['selector'][]     = '.listing-classic-1 .post-meta:after, .listing-item-grid-1 .post-meta:after';
...
// Hover Social Icon Of About us Widget
$theme_color['bg_color']['selector'][]     = '.site-footer .footer-widgets .bs-about .about-icons-list .about-icon-item a:hover';
