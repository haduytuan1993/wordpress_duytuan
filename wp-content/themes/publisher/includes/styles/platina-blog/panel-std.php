<?php
//
// Custom default values for platina-blog Demo
// 
...
$fields['post_continue_reading'][ $std_id ] = '1';
...
$fields['header_top_padding'][ $std_id ] = '44';
$fields['header_bottom_padding'][ $std_id ] = '44';
$fields['off_canvas_position'][ $std_id ] = 'left';
$fields['social_share_top_style'][ $std_id ] = 'style-2';
$fields['social_share_bottom_style'][ $std_id ] = 'style-4';
...
$fields['theme_color'][ $std_id ] = '#babb88';
$fields['topbar_text_color'][ $std_id ] = '#6e6e6e';
$fields['topbar_text_hcolor'][ $std_id ] = '#000000';
$fields['topbar_bg_color'][ $std_id ] = '#ffffff';
$fields['topbar_border_color'][ $std_id ] = '#e5e5e5';
$fields['topbar_icon_text_color'][ $std_id ] = '#000000';
$fields['topbar_icon_text_hcolor'][ $std_id ] = '#000000';
$fields['header_top_border'][ $std_id ] = '0';
$fields['header_menu_btop_color'][ $std_id ] = '#e5e5e5';
$fields['header_menu_st1_bbottom_color'][ $std_id ] = '#e5e5e5';
$fields['header_menu_text_color'][ $std_id ] = '#161616';
$fields['header_menu_text_h_color'][ $std_id ] = '#000000';
$fields['footer_link_color'][ $std_id ] = '#000000';
$fields['footer_link_hover_color'][ $std_id ] = '#494949';
$fields['footer_menu_bg_color'][ $std_id ] = '#f8f8f8';
$fields['footer_copy_bg_color'][ $std_id ] = '#f8f8f8';
$fields['footer_social_bg_color'][ $std_id ] = '';
$fields['footer_bg_color'][ $std_id ] = '#ffffff';
$fields['section_title_color'][ $std_id ] = '#000000';
$fields['section_title_bg_color'][ $std_id ] = '#c39f76';
...
$fields['typo_post_tp1_heading'][ $std_id ] = '32px';
...
$fields['typo_post_tp6_heading'][ $std_id ] = '32px';
$fields['typo_post_tp7_heading'][ $std_id ] = '32px';
$fields['typo_post_tp8_heading'][ $std_id ] = '32px';
$fields['typo_post_tp9_heading'][ $std_id ] = '32px';
$fields['typo_post_tp10_heading'][ $std_id ] = '32px';
